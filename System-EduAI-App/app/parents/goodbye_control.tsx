...
export default function GoodbyeControl() {
  // Dữ liệu mẫu cho các lớp (giống access_control)
  const classData = [
    {
      group: "Lớp mầm",
      classes: [
        {
          name: "Nur-A1",
          count: "18/20",
          teacher: "Lê Trần Ninh",
          status: "green",
        },
        {
          name: "Nur-A2",
          count: "10/20",
          teacher: "Lê Đình Thịnh",
          status: "yellow",
        },
        {
          name: "Nur-A3",
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={styles.greetingCard}>
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <View style={styles.greetingIconBox}>
              <MaterialIcons name="auto-awesome" size={32} color="#2196F3" />
            </View>
            <View style={{ marginLeft: 12 }}>
              <Text style={styles.greetingTitle}>Hẹn gặp lại!</Text>
              <Text style={styles.greetingSubtitle}>Cuối ngày vui vẻ!</Text>
            </View>
          </View>
        </View>
        {/* Danh sách lớp */}
        {classData.map((group, idx) => (
          <View
            ...
            style={{
              marginBottom: 8,
              opacity: group.group === "Lớp mầm" ? 1 : 0.3,
            }}
          >
                  ...
                  >
                    <View
                      style={[
                        ...
                        styles[
                          getStatusBorder(
                            cls.status as "green" | "yellow" | "red"
                          )
                        ],
                      ]}
                    >
